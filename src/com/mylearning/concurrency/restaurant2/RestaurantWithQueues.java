package com.mylearning.concurrency.restaurant2;
import com.mylearning.enumerated.menu.*;
	...
	public void run() {
		try {
			while(!Thread.interrupted()) {
				...
				System.out.println(this + " preparing " + requestedItem + " ordered by " + order.getWaitPerson() + " for " + order.getCustomer());
