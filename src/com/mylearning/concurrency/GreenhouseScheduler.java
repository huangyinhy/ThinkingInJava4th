package com.mylearning.concurrency;
...
public class GreenhouseScheduler {
	...
	class WaterOn implements Runnable {
		public void run() {
			// Put hardware control code here to physically turn on the water.
	...
	class WaterOff implements Runnable {
		public void run() {
			// Put hardware control code here to physically turn off the water.
